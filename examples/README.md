...
- `hf_space_app.py` — a public-facing Hugging Face Spaces example aligned with the repository’s live demo surface for image inference and constrained short-video analysis.
...
The public Hugging Face demo corresponding to the Space example is available at:
